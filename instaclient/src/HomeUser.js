...
class HomeUser extends Component {
    ...
    componentDidMount(){
      ...
      clickUbicacion(e){
        this.setState({ubicacion: e.latlng})
      }
              ...
              <Map onclick={this.clickUbicacion.bind(this)} style={{height:"100vh"}} center={position} zoom={this.state.zoom}>
...

                {
                  this.state.ubicacion ?
                    <Marker position={[this.state.ubicacion.lat, this.state.ubicacion.lng]} icon={myIconPlaceSelected}>
                      <Popup>
                        {this.state.ubicacion.lat} / {this.state.ubicacion.lng}
                      </Popup>
                    </Marker>:
                    ""
                }
