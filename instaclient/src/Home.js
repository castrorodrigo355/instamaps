...
class Home extends Component {
  ...
  seleccionarUbicacion(unaPosicion){
  ...
  render() {
    ...
    const posicionesRandom = [
                              {casa:"eduardo", posicion:[-34.6, -58.49]},
                              {casa:"cristian", posicion:[-34.6, -58.48]},
                              {casa:"rodrigo", posicion:[-34.6, -58.47]},
                              {casa:"federico", posicion:[-34.6, -58.46]},
                              {casa:"nicolas", posicion:[-34.6, -58.45]},
                              {casa:"ezequiel", posicion:[-34.6, -58.44]}]
    ...
    return (
      <div>
        <Map onclick={this.clickMapPlace.bind(this)} style={{height:"100vh"}} center={position} zoom={this.state.zoom}>
          ...
          <ul>
            {
              posicionesRandom.map((unaPosicion, i) => {
                return(
                  <div key={i}>
                    <Marker position={unaPosicion.posicion}
                            icon={myIcon}
